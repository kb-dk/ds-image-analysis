...
//                            openshift.newBuild("--strategy source", "--binary", "-i kb-infra/kb-s2i-tomcat90", "--name ds-image-analysis")
//                            openshift.startBuild("ds-image-analysis", "--from-dir=.", "--follow")
//                            openshift.newApp("ds-image-analysis:latest")
//                            openshift.create("route", "edge", "--service=ds-image-analysis")
//                        }
//                    }
//                }
